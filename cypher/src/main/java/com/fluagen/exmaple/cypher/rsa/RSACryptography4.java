 ...
 * 1. 密文的长度等于密钥长度
 * 2. 明文长度不能超过密钥长度
 * 3. Java 默认的 RSA 实现 "RSA/None/PKCS1Padding" 要求最小密钥长度为 512 位
 * 4. Java实现的RSA要求明文长度小于等于密钥长度（Bytes）-11
 * 
 * 如果使用1024bit长度的key，则最多可以加密128-11=117byte的数据
 * 所以，对于超过117byte的数据，需要以117byte为一组进行数据分割加密。
 *
 */
public class RSACryptography4 {

	public static String data = "12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890";
