package com.fluagen.exmaple.cypher.aes;
...
//		System.out.println("解密后数据: string:" + new String(decryptData));
		...
		/**
		 * 密钥长度可以是128比特、192比特、256比特中的任意一个,默认长度是128比特
		 * 换算成字节就是16字节、24字节、32字节
		 */
		String keyText = "1234567812345678";
		...
		System.out.println("密钥：长度 "+keyText.length());
		System.out.println();
